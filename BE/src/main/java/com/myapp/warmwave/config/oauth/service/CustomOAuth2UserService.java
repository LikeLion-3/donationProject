...
import com.myapp.warmwave.config.oauth.CustomOAuth2User;
import com.myapp.warmwave.config.oauth.OAuthAttributes;
import com.myapp.warmwave.config.oauth.SocialType;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new CustomOAuth2User(
                createdUser.getGrantedAuthorities(),
                attributes,
    ...
    private User getUser(OAuthAttributes attributes) {
        String userEmail = attributes.getOauth2UserInfo().getEmail();
    ...
    private User saveUser(OAuthAttributes attributes) {
        ...
        return (User) userRepository.save(createdUser);
    }
}
